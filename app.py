...
if "chat_history" not in st.session_state:
    st.session_state.chat_history = [AIMessage(content="Hello! I am GeniusBot, your AI-powered assistant for gaining insights from PDFs. Developed by Prashant Raj using GPT-3.5-turbo and Streamlit. How can I assist you today?")]
